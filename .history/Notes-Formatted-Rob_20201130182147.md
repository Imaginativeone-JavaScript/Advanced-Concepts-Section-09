...
function exploreJSRuntimeEnvironment() { 
  ...
  // 2
  // Job Queue
  Promise.resolve('Job Queue Contents').then((data) => console.log('2', data)) // Coming back to this

  // 3
  console.log('3', 'First Code to Execute') // This line is read into the call stack first, and then executed
}
```
